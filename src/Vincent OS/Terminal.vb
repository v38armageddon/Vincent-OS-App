Public Class Terminal
    ...
    Private Sub commande()
        If TextBox1.Text = "ver" Then
            ...
            RichTextBox1.Text = "Nom du système d'exploitation : Vincent OS" & vbCrLf & "Version : 7" & vbCrLf & "Branche : Officiel"
            TextBox1.Text = ""
        ...
        ElseIf TextBox1.Text = "Debug_Options_Help" Then
            RichTextBox1.Text = "Debug_Options_Custom" & vbCrLf & "Debug_Options_AllApps"
            TextBox1.Text = ""
