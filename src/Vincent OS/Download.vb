Public Class Download
    ...
    Private Sub Button6_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        If Button5.Enabled = False Or Button7.Enabled = False Or Button8.Enabled = False Or Button2.Enabled = False Or Button3.Enabled = False Then
            Dim errorsound As New System.Media.SoundPlayer(My.Resources.errorSound)
            errorsound.Play()
            MessageBox.Show("ERREUR : Vous ne pouvez lancer qu'un téléchargement à la fois.", "ERREUR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Else
    ...
    Private Sub Button7_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        If Button6.Enabled = False Or Button5.Enabled = False Or Button8.Enabled = False Or Button2.Enabled = False Or Button3.Enabled = False Then
            Dim errorsound As New System.Media.SoundPlayer(My.Resources.errorSound)
            errorsound.Play()
            MessageBox.Show("ERREUR : Vous ne pouvez lancer qu'un téléchargement à la fois.", "ERREUR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Else
    ...
    Private Sub Button8_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        If Button6.Enabled = False Or Button7.Enabled = False Or Button5.Enabled = False Or Button2.Enabled = False Or Button3.Enabled = False Then
            Dim errorsound As New System.Media.SoundPlayer(My.Resources.errorSound)
            errorsound.Play()
            MessageBox.Show("ERREUR : Vous ne pouvez lancer qu'un téléchargement à la fois.", "ERREUR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Else
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If Button6.Enabled = False Or Button7.Enabled = False Or Button5.Enabled = False Or Button8.Enabled = False Or Button3.Enabled = False Then
            Dim errorsound As New System.Media.SoundPlayer(My.Resources.errorSound)
            errorsound.Play()
            MessageBox.Show("ERREUR : Vous ne pouvez lancer qu'un téléchargement à la fois.", "ERREUR", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        If Button6.Enabled = False Or Button7.Enabled = False Or Button5.Enabled = False Or Button2.Enabled = False Or Button8.Enabled = False Then
            Dim errorsound As New System.Media.SoundPlayer(My.Resources.errorSound)
            errorsound.Play()
            MessageBox.Show("ERREUR : Vous ne pouvez lancer qu'un téléchargement à la fois.", "ERREUR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Else
